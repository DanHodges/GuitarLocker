...
{
    public class GuitarLockerRepository : IGuitarLockerRepository
    {
        public GuitarLockerContext _context;
        private ILogger<GuitarLockerRepository> _logger;

        public GuitarLockerRepository(GuitarLockerContext context, ILogger<GuitarLockerRepository> logger)
        {
            _context = context;
            _logger = logger;
        }
